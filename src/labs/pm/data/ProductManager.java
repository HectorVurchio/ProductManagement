...
//	private ResourceFormatter formatter;
	...
	private final Path reportsFolder = Path.of(dir,"Desktop",config.getString("reports.folder"));
	private final Path dataFolder = Path.of(dir,"Desktop",config.getString("data.folder"));
	private final Path tempFolder = Path.of(dir,"Desktop",config.getString("temp.folder"));
	...
	private static final Map<String,ResourceFormatter> formatters = Map.of(
											...
											"es-VE",new ResourceFormatter(new Locale("es","VE")),
